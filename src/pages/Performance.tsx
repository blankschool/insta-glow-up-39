...
const Performance = () => {
  ...
  const performanceOverTime = [
    { date: '01/12', impressions: 15000, reach: 12000, engagement: 850 },
    { date: '02/12', impressions: 18000, reach: 14500, engagement: 920 },
    { date: '03/12', impressions: 16500, reach: 13200, engagement: 780 },
    { date: '04/12', impressions: 21000, reach: 17000, engagement: 1100 },
    { date: '05/12', impressions: 19500, reach: 15800, engagement: 950 },
    { date: '06/12', impressions: 23000, reach: 18500, engagement: 1250 },
    { date: '07/12', impressions: 20000, reach: 16000, engagement: 1050 },
  ];

  const radarData = [
    { metric: 'Alcance', value: 85, fullMark: 100 },
    { metric: 'Engajamento', value: 72, fullMark: 100 },
    { metric: 'Impressões', value: 90, fullMark: 100 },
    { metric: 'Saves', value: 65, fullMark: 100 },
    { metric: 'Shares', value: 58, fullMark: 100 },
    { metric: 'Cliques', value: 45, fullMark: 100 },
  ];

  const interactionBreakdown = [
    { type: 'Curtidas', value: totalLikes, percentage: 75 },
    { type: 'Comentários', value: totalComments, percentage: 15 },
    { type: 'Salvos', value: Math.round(totalLikes * 0.08), percentage: 6 },
    { type: 'Compartilhamentos', value: Math.round(totalLikes * 0.05), percentage: 4 },
  ];
          ...
          <table className="data-table">
            ...
            <tbody>
              <tr>
                ...
                <td>{Math.max(...media.map(m => m.like_count || 0)).toLocaleString()}</td>
                <td>
              ...
              <tr>
                ...
                <td>{Math.max(...media.map(m => m.comments_count || 0)).toLocaleString()}</td>
                <td>
                  <span className="tag tag-good">
                    <TrendingUp className="w-3 h-3 mr-1" />
                    +8%
